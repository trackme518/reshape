...
function wpdocs_theme_name_scripts() {
  ...
  //wp_enqueue_style( 'fontawesome', get_stylesheet_uri() );//fontawesome.css
  ...
  //wp_enqueue_style( 'fontawesome', 'fontawesome-free-5.15.1-web/css/fontawesome.min.css' );
  //wp_enqueue_style( 'fontawesome', 'fontawesome-free-5.15.1-web/css/fontawesome.min.css' );
                                                                     
  wp_enqueue_style( 'fontawesome',  get_template_directory_uri() . '/fontawesome5/css/all.min.css' );
