...
function assignLabels(){
  var labels = document.getElementsByClassName("3dlabel"); //get all labesl based on class - generated by php in index
    for (i = 0; i < labels.length; i++) {
      var labeltarget = labels[i].dataset.labelfor; //get id to which assing this label to
      //A-Frame returns the actual Object3D.position vector object 
      var getposition = document.getElementById(labeltarget).getAttribute("position"); //https://aframe.io/docs/1.0.0/components/position.html#getting-position
      var setposition = getposition.x + " " + ( getposition.y + 1 ) + " " + getposition.z;
      labels[i].setAttribute("position", setposition); //assign position same as given category?
      
      console.log('label assigned for: ' + labeltarget + ' position: ' + setposition );
    }  
}
