...
AFRAME.registerComponent('orbit-controls', {
  ...
  tick: function () {
    ...
    var currPos = this.el.getObject3D('camera').position.x + ' ' + this.el.getObject3D('camera').position.y + ' ' + this.el.getObject3D('camera').position.z;
    //assign current position of orbital camera to object so we can use look at - billboard style functionality
    document.getElementById('cam').setAttribute("position", currPos ); 
  },
